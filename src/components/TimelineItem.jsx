...
function TimelineItem({ year, title, duration, details }) { //eslint-disable-line
  return (
    ...
    border-stone-200 dark:border-stone-700">
        <li className='mb-10 ml-4'>
            ...
            mt-1.5 -left-1.5 border border-white dark:border-stone-900
            dark:bg-stone-700" />
            ...
            justify-start text-xs md:text-sm">
                ...
                text-white dark:text-stone-900 bg-stone-900 
